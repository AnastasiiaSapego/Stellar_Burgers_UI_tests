...
public class SignInForm extends BasePage {
    ...
    private final By emailInputByLabel     = By.xpath("//form//fieldset[.//label[normalize-space()='Email']]//input[contains(@class,'input__textfield')]");
    private final By passwordInputByLabel  = By.xpath("//form//fieldset[.//label[normalize-space()='Пароль']]//input[contains(@class,'input__textfield')]");
    private final By emailInputFallback    = By.xpath("//form//fieldset[1]//input[@type='text' or @type='email' or contains(@class,'input__textfield')]");
    private final By passwordInputFallback = By.xpath("//form//fieldset[2]//input[@type='password' or contains(@class,'input__textfield')]");
